                ...
                <div class="ibox-body">
                    ...
                    <table id="example-table" class="table table-striped table-bordered ">
                        ...
                        @foreach($products as $product)
                            ...
                            <td>
                                <a href="{{route('product.show',$product->id)}}"  class="float-left ml-2 btn btn-outline-secondary btn-sm"><i class="fa fa-plus-circle"></i></a>
                                ...
                                <a href="{{route('product.edit',$product->id)}}" class="float-left ml-2 btn btn-outline-info btn-sm"><i class="fa fa-edit"></i></a>
