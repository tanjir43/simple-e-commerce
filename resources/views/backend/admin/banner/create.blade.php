...
@section('body')
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title mx-auto">Add Banner Form</div>
                ...
                <div class="ibox-body">
                    ...
                    <form class="form-horizontal" action="{{route('banner.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="slug" type="text" placeholder="Url" value="{{old('slug')}}" required >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Description</label>
                            <div class="col-sm-10">
                                <textarea name="description" id="summernote"  required  class="form-control" placeholder="Banner description">{!!html_entity_decode(old('description'))  !!}</textarea>
                            </div>
                        </div>
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control-file" type="file" name="photo" accept="image/*" required>
                            </div>
                        </div> --}}
