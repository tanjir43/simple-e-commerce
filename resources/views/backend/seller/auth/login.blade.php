...
<div class="content">
    <div class="brand">
        <a class="link" href="index.html"><img src="{{asset(get_setting('logo'))}}" alt=""></a>
    </div>
    <form id="login-form"  method="POST" action="{{ route('seller.login') }}">
        @csrf
        <h2 class="login-title">Log in as seller </h2>
