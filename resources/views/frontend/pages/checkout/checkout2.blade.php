...
@section('body')
    ...
    <main class="main">
        <div class="page-header text-center" style="background-image: url({{asset('/')}}'assets/images/page-header-bg.jpg')">
            <div class="container">
                <h1 class="page-title">Checkout2<span>Shop</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Checkout2</li>
                </ol>
            </div><!-- End .container -->
                            ...
                            @if(count($shippings)>0)
                                @foreach($shippings as $key=>$shipping)
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <input type="radio" id="customRadio{{$key}}" name="delivery_charge"  value="{{$shipping->delivery_charge}}" s="custom-control-label">
                                ...
                                @endforeach
                            @else
                                <td>No Shipping method is found!!</td>
                            @endif
                            </tbody>
                        </table>
                        <div class="row">
