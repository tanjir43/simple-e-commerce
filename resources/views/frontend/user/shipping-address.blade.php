...
@section('body')
    ...
    <div class="page-header mb-0 pb-0  text-center" style="background-image: url('{{asset('/')}}assets/images/page-header-bg.jpg')">
        <div class="container">
            ...
            <h5 class="page-title"><span>Shipping address</span></h5>
        </div>
    </div>
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav mt-0 mb-2">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('users.shipping-address')}}">Shipping  address</a></li>
            </ol>
        </div>
    </nav>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="list-inline dashboard-menu text-center">
                        ...
                        <li><a class="active" href="{{route('users.shipping-address')}}">Shipping Address</a></li>
                    ...
                    <div class="dashboard-wrapper user-dashboard">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                <tr>
                                    <td  class="text-center">{{$user->scountry}}</td>
                                    <td  class="text-center">{{$user->sstate}}</td>
                                    <td  class="text-center">{{$user->scity}}</td>
                                    <td  class="text-center"> {{$user->spostcode}}</td>
                                    <td  class="text-center">{!! $user->saddress !!}</td>
                                    <td  class="text-center">
                                        <a href="{{route('users.edit-shipping-address')}}"><button type="button" class="btn btn-default"><i class="tf-pencil2"  aria-hidden="true" ></i></button></a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
